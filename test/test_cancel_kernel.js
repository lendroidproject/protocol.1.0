...
contract("Protocol", function (addresses) {
  ...
  beforeEach(async function () {
    ...
    // let _kernel_creator_signature = await web3.eth.personal.sign(kernel_hash, this.lender, 'password')
  ...
  it("cancel_kernel should be callable only by creator", async function() {
    let _lend_currency_cancel_value = web3.utils.toWei('40', 'ether')
    let errr = false
    try {
  ...
  it("cancel_kernel should not work if cancel value exceeds the maximum value", async function() {
    let _lend_currency_cancel_value = web3.utils.toWei('41', 'ether')
    let errr = false
    try {
      await this.protocolContract.cancel_kernel(
        this.kernel_addresses, this.kernel_values,
  ...
  it("cancel_kernel should work if cancel value = maximum value - filled value", async function() {
    ...
    // let _wrangler_signature = await web3.eth.personal.sign(this.position_hash, this.wrangler, 'password')
    ...
    let _lend_currency_cancel_value = web3.utils.toWei('10', 'ether')
    let errr = false
    try {
      await this.protocolContract.cancel_kernel(
        this.kernel_addresses, this.kernel_values,
  ...
  it("cancel_kernel should not work if cancel_value > maximum value - filled value", async function() {
    ...
    let _lend_currency_cancel_value = web3.utils.toWei('11', 'ether')
    let errr = false
    try {
      await this.protocolContract.cancel_kernel(
        this.kernel_addresses, this.kernel_values,
  ...
  it("cancel_kernel should work if cancel_value < maximum value - filled value", async function() {
    ...
    let _lend_currency_cancel_value = web3.utils.toWei('9', 'ether')
    let errr = false
    try {
      await this.protocolContract.cancel_kernel(
        this.kernel_addresses, this.kernel_values,
